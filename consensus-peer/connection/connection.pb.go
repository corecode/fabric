...
func (c *atomicBroadcastClient) Broadcast(ctx context.Context, in *Message, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	err := grpc.Invoke(ctx, "/connection.atomic_broadcast/broadcast", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *atomicBroadcastClient) Deliver(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (AtomicBroadcast_DeliverClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_AtomicBroadcast_serviceDesc.Streams[0], c.cc, "/connection.atomic_broadcast/deliver", opts...)
	if err != nil {
		return nil, err
	}
...
var _AtomicBroadcast_serviceDesc = grpc.ServiceDesc{
	ServiceName: "connection.atomic_broadcast",
